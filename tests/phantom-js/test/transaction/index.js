...
describe("transaction.js", function () {
  ...
  var transaction = phantom.transaction;
  ...
  describe("#createTransaction", function () {
    ...
    describe("returned transaction", function () {
      ...
      it("should be signed correctly", function () {
        var result = phantom.crypto.verify(trs);
        result.should.equal(true);
      });

      it("should be deserialised correctly", function () {
        var deserialisedTx = phantom.crypto.fromBytes(phantom.crypto.getBytes(trs).toString("hex"));
  ...
  describe("createTransaction and try to tamper signature", function(){
    ...
    it("should not validate overflown signatures", function(){
      ...
      var old_transaction = phantom.transaction.createTransaction('AacRfTLtxAkR3Mind1XdPCddj1uDkHtwzD', 1, null, 'randomstring');
      ...
      */
      ...
      // console.log("TXID " + phantom.crypto.getId(old_transaction));
      // console.log("VERIFY " + phantom.crypto.verify(old_transaction));
      // console.log("SIG " + old_transaction.signature + "\n");

      phantom.crypto.verify(old_transaction).should.equal(true);
      ...
      phantom.crypto.verify(old_transaction).should.equal(false);
  ...
  describe("#createTransaction with second secret", function () {
    ...
    var keys = phantom.crypto.getKeys(secondSecret);
    ...
    describe("returned transaction", function () {
      ...
      it("should be second signed correctly", function () {
        var result = phantom.crypto.verifySecondSignature(trs, keys.publicKey);
        (result).should.equal(true);
      });
